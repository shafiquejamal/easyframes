...
class TestEgen(unittest.TestCase):
	...
	def test_no_include_no_exclude_includes_all_rows(self):
		...
		myhhkit.egen(operation='count', groupby='hh', col='hh')
	...
	def test_specify_include_yields_correct_results_count(self):
		myhhkit = hhkit(self.df)
		# myhhkit.from_dict(self.df)
		myhhkit.egen(operation='count', groupby='hh', col='hh', include=self.my_include)
	...
	def test_specify_include_yields_correct_results_mean(self):
		myhhkit = hhkit(self.df)
		# myhhkit.from_dict(self.df)
		myhhkit.egen(operation='mean', groupby='hh', col='age', include=self.my_include)
	...
	def test_specify_exclude_yields_correct_results_count(self):
		myhhkit = hhkit(self.df)
		# myhhkit.from_dict(self.df)
		myhhkit.egen(operation='count', groupby='hh', col='hh', exclude=self.my_include)
	...
	def test_specify_exclude_yields_correct_results_mean(self):
		myhhkit = hhkit(self.df)
		# myhhkit.from_dict(self.df)
		myhhkit.egen(operation='mean', groupby='hh', col='age', exclude=self.my_include)
	...
	def test_using_numeric_exclude_type(self):
		myhhkit = hhkit(self.df)
		# myhhkit.from_dict(self.df)
		myhhkit.egen(operation='mean', groupby='hh', col='age', exclude=self.my_include_using_integer)
		correct_values = pd.Series([33.333333, 33.333333, 33.333333, np.nan, 20, 20, 15, 15, 15, 15])
		assert_series_equal(correct_values, myhhkit.df['(mean) age by hh'])
	...
	def test_using_float_exclude_type(self):
		myhhkit = hhkit(self.df)
		# myhhkit.from_dict(self.df)
		myhhkit.egen(operation='mean', groupby='hh', col='age', exclude=self.my_include_using_float)
		correct_values = pd.Series([33.333333, 33.333333, 33.333333, np.nan, 20, 20, 15, 15, 15, 15])
		assert_series_equal(correct_values, myhhkit.df['(mean) age by hh'])
	...
	def test_using_nonnumeric_exclude_type(self):
		myhhkit = hhkit()
		try:
			df2 = myhhkit.egen(operation='mean', groupby='hh', col='age', exclude=self.my_include_using_nonnumeric)
		except:
			return True
		return False
